...
namespace Gaskellgames.InputEventSystem
{
    ...
    public class XRInputControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // banner
            Texture banner = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Gaskellgames/Input Event System/Editor/Icons/inspectorBanner_InputEventSystem.png", typeof(Texture));
